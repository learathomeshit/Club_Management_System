<template>
    <div class="login-container">
      ...
      <div style="width: 25%; height: 50%; display: flex;background-color: white; ">

        <div style="flex: 1;width: 50%;  padding: 40px;display: flex;flex-direction: column;justify-content: center;" >
          <div style="text-align: center; font-size: 30px; margin-bottom: 60px; color: #333">校园社团管理系统</div>
          <el-form :model="loginForm" :rules="rules" ref="loginForm">
            ...
            <el-form-item >
              <el-button
                  style="margin-top: 20px; background-color: #2A60C9; width: 167px ;color: #ffffff"
                  @click="submitForm('loginForm')"
                >用户登录</el-button>
              <el-button
                  style="margin-top: 20px; background-color: #35c92a; width: 167px;color: #ffffff"
                  @click="showAddWin()"
                   >用户注册</el-button>
